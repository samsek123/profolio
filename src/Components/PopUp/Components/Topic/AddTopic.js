...
class AddTopic extends Component<Props> {
  constructor() {
    super();
    this.state = {
      topicName: '',
  ...
  render() {
    const { classes, handleClose, t, openAddTopic } = this.props;
    const { topicName, topicDescription, topicTags, topicCategory, topicParticipant } = this.state;
    const popUpTitle = t('component.popUp.addTopic.popUpTitle');
    const popUpDescription = t('component.popUp.addTopic.popUpDescription');
    return (
      <Dialog
        fullWidth={true}
        maxWidth="md"
...
AddTopic.propTypes = {
  ...
  openAddTopic: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  // i18n
  t: PropTypes.func.isRequired,
}

export default withNamespaces('translation')(withStyles(styles)(AddTopic));
