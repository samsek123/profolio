...
class EditPreference extends Component<Props> {
  constructor() {
    super();
    this.state = {
      step: 1,
  ...
  render() {
    const { classes, openEditPreference, handleClose, t } = this.props;
...
EditPreference.propTypes = {
  classes: PropTypes.object.isRequired,
  openEditPreference: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  // i18n
  t: PropTypes.func.isRequired,
}

export default withNamespaces('translation')(withStyles(styles)(EditPreference));
